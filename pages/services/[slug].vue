...
const getServiceKeywords = (slug: string | undefined): string => {
  if (!slug) return 'nexora, услуги, веб-разработка'
  
  const keywordsMap: Record<string, string> = {
    'web-architecture': 'веб-архитектура, архитектура веб-приложений, микросервисная архитектура, системное проектирование, API-first подход, масштабируемые решения, производительность системы, надежность системы, безопасность архитектуры, облачная архитектура',
    'website-development': 'разработка сайтов, создание сайтов, веб-разработка, адаптивный дизайн, современные технологии, оптимизация производительности, интеграция с сервисами, SEO оптимизация, кроссбраузерная совместимость, мобильная версия сайта',
    'interface-products': 'интерфейсные продукты, разработка интерфейсов, веб-интерфейсы, мобильные интерфейсы, кросс-платформенная разработка, интерактивные прототипы, тестирование UX, оптимизация интерфейсов, пользовательский опыт, продуктовый дизайн',
    'ux-ui-design': 'UX дизайн, UI дизайн, пользовательский опыт, проектирование интерфейсов, исследование пользователей, информационная архитектура, прототипирование, визуальный дизайн, тестирование интерфейсов, итеративный дизайн',
    'design-systems': 'дизайн-системы, компонентная библиотека, гайдлайны, дизайн-токены, стиль-гайд, система компонентов, документация дизайна, консистентность интерфейса, масштабируемый дизайн, дизайн-язык',
    'corporate-websites': 'корпоративные сайты, сайт компании, представительский сайт, корпоративный стиль, многоязычность, CRM интеграция, аналитика, административная панель, корпоративный портал, брендинг компании',
    'web-services': 'веб-сервисы, веб-платформы, автоматизация процессов, бизнес-процессы, интеграции, API разработка, масштабируемая инфраструктура, безопасность данных, мониторинг систем, облачные решения',
    'support-development': 'поддержка сайтов, техническая поддержка, развитие продукта, обновления сайта, исправление ошибок, добавление функций, мониторинг работы, оптимизация производительности, сопровождение проекта, обслуживание сайта',
    'optimization-seo': 'SEO оптимизация, продвижение сайтов, поисковая оптимизация, SEO аудит, техническая оптимизация, контент-стратегия, ускорение загрузки, улучшение индексации, органический трафик, поисковый маркетинг',
    'technical-audit': 'технический аудит, аудит сайта, анализ кода, проверка производительности, безопасность сайта, архитектурный анализ, рекомендации по улучшению, анализ производительности, технический анализ, оптимизация кода',
  }
  
  return keywordsMap[slug] || 'nexora, веб-разработка, цифровые продукты'
}
...
useHead(() => ({
  ...
  meta: [
    ...
    {
      name: 'keywords',
      content: getServiceKeywords(service.value?.slug),
    },
    {
      property: 'og:title',
      content: service.value ? `${service.value.title} - nexora` : 'Услуга не найдена - nexora',
    },
    {
    ...
    {
      property: 'og:url',
      content: service.value ? `https://nexorastudio.site/services/${service.value.slug}` : 'https://nexorastudio.site/services',
    },
    {
      name: 'twitter:title',
      content: service.value ? `${service.value.title} - nexora` : 'Услуга не найдена - nexora',
