...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-dEZbUZA3.mjs')
  },
  {
    name: "services-slug",
    path: "/services/:slug()",
    component: () => import('./_slug_-CT0zmyz9.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-B1vzKGkL.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BBmlb4Nh.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-9tYry_Vi.mjs'));
...
export { _export_sfc as _, useNuxtApp as a, useRuntimeConfig as b, nuxtLinkDefaults as c, __nuxt_component_0$2 as d, entry_default as default, __nuxt_component_0 as e, navigateTo as n, resolveRouteObject as r, tryUseNuxtApp as t, useRouter as u };
